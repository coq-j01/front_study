...
export function Notification(props) {
  {
    return (
      <p>
        {parseInt(props.count) <= 0 || props.count == undefined
          ? "새로운 알림이 없습니다."
...
export function Advertisement(props) {
  const advertise = props.isPremium;
  return <div>{!advertise && <span>광고가 보입니다.</span>}</div>;
}
export function Premiun(props) {
